  ...
  const I18N = {
    ...
    zh: {
      ...
      about: {
        ...
        title: "自我介绍",
        lead:
          "我目前在哥本哈根大玻尔研究所攻读天文学博士，从事空间望远镜数据处理与分析。在哥本哈根大学，我师从Lise Christensen 和 Koki Kakichi。我主要参与 COSMOS-3D 无缝光谱巡天，重点研究方向是第一代恒星，宇宙再电离等问题。我曾在清华大学天文系攻读硕士学位，导师为蔡峥教授；此前毕业于四川大学航空航天工程系，获工学学士学位（吴玉章学院荣誉学士学位）。",
        p2:
